...
const App = () => {
  ...
  const fetchEvents = async () => {
    try {
      const response = await axios.get('http://34.22.74.94/get_event.php');
  ...
  const addEvent = async () => {
    try {
      ...
      await axios.post('http://34.22.74.94/add_event.php', formData, {
        headers: {
  ...
  const deleteEvent = async eventId => {
    try {
      await axios.post('http://34.22.74.94/delete_event.php', {
        id: eventId,
      });
      fetchEvents();
    } catch (error) {
